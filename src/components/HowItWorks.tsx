  ...
  const steps = [
    {
      ...
      description: "Link your frequent flyer programs - Qantas, Velocity, Virgin, and more. Enter your current points balance.",
      color: "blue"
    },
    {
      step: "02", 
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              ...
              <div className="text-center">
                <div className={`inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r ${colorMap[step.color]} mb-6 text-white font-bold text-xl`}>
                  {step.step}
                </div>
